...
public class FileUploadController {
	...
	{
		//String string=null;                      //Custom made Exception to check Centralized Exception
		//System.out.println(string.charAt(0));    //Custom made Exception to check Centralized Exception 
		return"fileform";
	}
